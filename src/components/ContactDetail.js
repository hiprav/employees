...
const ContactDetail = ({ updateContact, updateImage }) => {
    ...
    return (
        <>
            <Link to={'/contacts'} className='link count_list'><i className='bi bi-arrow-left'></i> Back to list</Link>
                    ...
                    <div>
                        <form onSubmit={onUpdateContact} className="form">
                            ...
                            <div className="form_footer">
                                ...
                                <button type="delete" onClick={onDeleteContact} className="btn btn-danger">Delete</button>
                            </div>
                        </form>
                    </div>
                </div>
